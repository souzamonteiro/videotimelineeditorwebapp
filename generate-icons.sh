...
# Script to generate all the icons for the Video Timeline Editor PWA

echo "Generating icons for the Video Timeline Editor PWA..."
...
cat > www/manifest.json << EOF
{
  ...
  "short_name": "VideoTimelineEditor",
  "start_url": "./index.html",
  "display": "standalone",
  "theme_color": "#3498db",
  "background_color": "#f5f7fa",
  "description": "A web-based video timeline editor application.",
  "icons": [
    {
